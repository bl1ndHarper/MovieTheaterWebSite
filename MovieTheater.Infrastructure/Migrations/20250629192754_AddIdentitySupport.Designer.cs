...
namespace MovieTheater.Infrastructure.Migrations
{
    ...
    [Migration("20250629192754_AddIdentitySupport")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieTheater.Infrastructure.Entities.SessionSeat", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("MovieTheater.Infrastructure.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MovieTheater.Infrastructure.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("MovieTheater.Infrastructure.Entities.SessionSeat", "Seat")
                        .WithMany()
            ...
            modelBuilder.Entity("MovieTheater.Infrastructure.Entities.SessionSeat", b =>
                {
                    b.HasOne("MovieTheater.Infrastructure.Entities.HallSeat", "HallSeat")
                        .WithMany()
                        .HasForeignKey("HallSeatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MovieTheater.Infrastructure.Entities.Session", "Session")
